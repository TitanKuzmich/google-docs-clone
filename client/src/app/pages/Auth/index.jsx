...
const Auth = () => {
    ...
    const signInGoogle = () => {
        auth.signInWithPopup(provider).catch(() => setError(errorMessage.signUpError))
    }
                ...
                <div className={style.auth_header}>
                    {
                        ...
                        && <span>Sign In to the TiSai Docs</span>
                    }

                    {type === methodTypes.signUp && <span>Sign Up to the TiSai Docs</span>}
                </div>
